...
public class VasMailNpsMultibrandService {
    ...
    private static final Logger LOGGER = Logger.getLogger(VasMailNpsMultibrandService.class.getName());
    ...
    public VasMailNpsMultibrandService(VasMailNpsRepository vasMailNpsRepository,
